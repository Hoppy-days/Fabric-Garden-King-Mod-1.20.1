...
import net.jeremy.gardenkingmod.screen.GardenOvenScreen;
    ...
    public void onInitializeClient() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            while (toggleLeaderboardKey.wasPressed()) {
                if (client != null && client.player != null && client.currentScreen == null) {
                    boolean nowVisible = ScoreboardLeaderboardHudOverlay.INSTANCE.toggleVisible();
                    client.player.sendMessage(
                            Text.translatable("message.gardenkingmod.leaderboard.toggled", nowVisible ? "ON" : "OFF"),
                            true);
                }
            }
        });
        ...
        HandledScreens.register(ModScreenHandlers.GARDEN_OVEN_SCREEN_HANDLER, GardenOvenScreen::new);
        ...
        HudRenderCallback.EVENT.register(ScoreboardLeaderboardHudOverlay.INSTANCE);
