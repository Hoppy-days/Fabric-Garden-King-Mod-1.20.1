...
public enum TopazArmorMaterial implements ArmorMaterial {
        INSTANCE;

        private static final int DURABILITY_MULTIPLIER = 36;
        private static final int ENCHANTABILITY = 22;
        private static final float TOUGHNESS = 2.75F;
        private static final float KNOCKBACK_RESISTANCE = 0.075F;
        ...
        public String getName() {
                return GardenKingMod.MOD_ID + ":topaz";
        }
