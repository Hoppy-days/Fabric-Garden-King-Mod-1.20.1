...
public class SprinklerModel2 extends EntityModel<Entity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData rotation = modelPartData.addChild("rotation", ModelPartBuilder.create().uv(8, 31).cuboid(-10.5F, -3.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F))
		...
		.uv(28, 19).cuboid(0.5F, -2.0F, -3.0F, 1.0F, 1.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(-1.5F, 3.0F, 0.5F));
		...
		.uv(16, 33).cuboid(0.5F, -1.0F, -2.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(-1.5F, -2.0F, 0.5F));
