...
public class SprinklerModel extends EntityModel<Entity> {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(
            new Identifier(GardenKingMod.MOD_ID, "sprinkler"),
            "main"
    );
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData rotation = modelPartData.addChild("rotation",
                ModelPartBuilder.create()
                        .uv(8, 31).cuboid(-10.5F, -3.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F))
                        .uv(12, 31).cuboid(9.5F, 0.0F, -0.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F))
                        .uv(0, 27).cuboid(-0.5F, -3.0F, -0.5F, 1.0F, 5.0F, 1.0F, new Dilation(0.0F)),
                ModelTransform.pivot(0.0F, -7.0F, 0.0F));

        rotation.addChild("cube_r1",
                ModelPartBuilder.create().uv(24, 11).cuboid(8.5F, -8.0F, -0.5F, 1.0F, 10.0F, 1.0F, new Dilation(0.0F)),
                ModelTransform.of(8.5F, 8.5F, 0.0F, 0.0F, 0.0F, -1.5708F));

        rotation.addChild("cube_r2",
                ModelPartBuilder.create().uv(24, 0).cuboid(0.0F, -10.0F, 0.0F, 1.0F, 10.0F, 1.0F, new Dilation(0.0F)),
                ModelTransform.of(-0.5F, 0.0F, -0.5F, 0.0F, 0.0F, -1.5708F));

        rotation.addChild("cap3",
                ModelPartBuilder.create()
                        .uv(22, 28).cuboid(-1.0F, -2.0F, -1.0F, 2.0F, 1.0F, 1.0F, new Dilation(0.0F))
                ...
                ModelTransform.pivot(-1.5F, 3.0F, 0.5F));

        rotation.addChild("cap2",
                ModelPartBuilder.create()
                        .uv(16, 31).cuboid(0.0F, -1.0F, -1.0F, 1.0F, 1.0F, 1.0F, new Dilation(0.0F))
                ...
                ModelTransform.pivot(-1.5F, -2.0F, 0.5F));

        modelPartData.addChild("cap4",
                ModelPartBuilder.create()
                        .uv(28, 4).cuboid(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F))
        ...
        ModelPartData bbMain = modelPartData.addChild("bb_main",
                ModelPartBuilder.create().uv(24, 22).cuboid(-1.0F, -29.0F, -1.0F, 2.0F, 4.0F, 2.0F, new Dilation(0.0F)),
                ModelTransform.pivot(0.0F, 24.0F, 0.0F));

        bbMain.addChild("cube_r3",
                ModelPartBuilder.create().uv(16, 0).cuboid(-1.0F, -24.0F, -1.0F, 2.0F, 25.0F, 2.0F, new Dilation(0.0F)),
                ModelTransform.of(6.0F, 0.0F, -6.0F, -0.3054F, -0.7854F, 0.0F));

        bbMain.addChild("cube_r4",
                ModelPartBuilder.create().uv(8, 0).cuboid(-1.0F, -24.0F, -1.0F, 2.0F, 25.0F, 2.0F, new Dilation(0.0F)),
                ModelTransform.of(-6.0F, 0.0F, -6.0F, -0.3054F, 0.7854F, 0.0F));

        bbMain.addChild("cube_r5",
                ModelPartBuilder.create().uv(0, 0).cuboid(-1.0F, -24.0F, -1.0F, 2.0F, 25.0F, 2.0F, new Dilation(0.0F)),
    ...
    public void setAnimationProgress(float animationProgress) {
        float spin = animationProgress * MathHelper.TAU;
        this.rotation.yaw = spin;

        this.cap2.pitch = 0.0F;
        this.cap3.pitch = 0.0F;
        this.cap4.pitch = 0.0F;
    }
